    ...
    return(
        ...
        <h2 className='titleReview'>Ils ont aimé notre vision</h2>
            <div className="review">
                ...
                <p className="textReview">KORO est la meilleure application pour la culture.</p>
            ...
            <div className="review">
                ...
                <p className="textReview">Je dis oui ! Oui, à KORO ! Je chante Koro ! Vive KORO !</p>
                <p className='authorReview'>Francois L.</p>
            </div>
            <div className="review">
                <img src="macron.jpg" className='imgReview'/>
                <p className="textReview">Parce que c'est un BEAU PROJET ! <br/>KORO, c'est le progrès.</p>
                <p className='authorReview'>Emmanuel M.</p>
            </div>
        </div>
        </>
